                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (!((_a = this.odpConfig) === null || _a === void 0 ? void 0 : _a.isReady())) {
                            this.logger.log(LogLevel.ERROR, "".concat(EVENT_SENDING_FAILURE_MESSAGE, " (").concat(ODP_CONFIG_NOT_READY_MESSAGE, ")"));
...
var BrowserOdpManager = /** @class */ (function (_super) {
    ...
    function BrowserOdpManager(_a) {
        ...
        if (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.disabled) {
            ...
            _this.enabled = false;
            _this.logger.log(LogLevel.INFO, LOG_MESSAGES.ODP_DISABLED);
            return _this;
        }
        ...
        _this.initPromise = _this.initializeVuid(BrowserOdpManager.cache).catch(function (e) {
            _this.logger.log(_this.enabled ? LogLevel.ERROR : LogLevel.DEBUG, e);
        });
        return _this;
    }
    /**
