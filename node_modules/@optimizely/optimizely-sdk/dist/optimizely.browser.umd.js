(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ERROR_MESSAGES = {
        ...
        ODP_SDK_KEY_MISSING_NOTIFICATION_CENTER_FAILURE: '%s: You must provide an sdkKey. Cannot start Notification Center for ODP Integration.',
    ...
    var BROWSER_CLIENT_VERSION = '5.0.1';
    var NODE_CLIENT_VERSION = '5.0.1';
    ...
    var OdpConfig = /** @class */ (function () {
        function OdpConfig(apiKey, apiHost, pixelUrl, segmentsToCheck) {
            this._apiKey = apiKey !== null && apiKey !== void 0 ? apiKey : '';
            this._apiHost = apiHost !== null && apiHost !== void 0 ? apiHost : '';
            this._pixelUrl = pixelUrl !== null && pixelUrl !== void 0 ? pixelUrl : '';
            this._segmentsToCheck = segmentsToCheck !== null && segmentsToCheck !== void 0 ? segmentsToCheck : [];
        }
        Object.defineProperty(OdpConfig.prototype, "apiHost", {
            /**
        ...
        Object.defineProperty(OdpConfig.prototype, "apiKey", {
            /**
        ...
        Object.defineProperty(OdpConfig.prototype, "pixelUrl", {
            /**
        ...
        Object.defineProperty(OdpConfig.prototype, "segmentsToCheck", {
            /**
         ...
         */
        OdpConfig.prototype.update = function (config) {
            if (this.equals(config)) {
                ...
                if (config.pixelUrl)
                    this._pixelUrl = config.pixelUrl;
         ...
         */
        OdpConfig.prototype.isReady = function () {
        ...
        OdpConfig.prototype.equals = function (configToCompare) {
            return (this._apiHost === configToCompare._apiHost &&
    ...
    var OdpManager = /** @class */ (function () {
        function OdpManager() {
             ...
             * @protected
             */
            this.logger = getLogger(); // TODO: Consider making private and moving instantiation to constructor
            /**
             * ODP configuration settings for identifying the target API and segments
             */
            this.odpConfig = new OdpConfig(); // TODO: Consider making private and adding public accessors
         ...
         */
        OdpManager.prototype.updateSettings = function (_a) {
            var _b;
            var apiKey = _a.apiKey, apiHost = _a.apiHost, pixelUrl = _a.pixelUrl, segmentsToCheck = _a.segmentsToCheck;
            if (!this.enabled) {
                return false;
            }
            if (!this.eventManager) {
                this.logger.log(exports.LogLevel.ERROR, ERROR_MESSAGES.ODP_MANAGER_UPDATE_SETTINGS_FAILED_EVENT_MANAGER_MISSING);
                return false;
            }
            if (!this.segmentManager) {
                this.logger.log(exports.LogLevel.ERROR, ERROR_MESSAGES.ODP_MANAGER_UPDATE_SETTINGS_FAILED_SEGMENTS_MANAGER_MISSING);
                return false;
            }
            this.eventManager.flush();
            var newConfig = new OdpConfig(apiKey, apiHost, pixelUrl, segmentsToCheck);
            var configDidUpdate = this.odpConfig.update(newConfig);
            if (configDidUpdate) {
                this.odpConfig.update(newConfig);
                (_b = this.segmentManager) === null || _b === void 0 ? void 0 : _b.reset();
                return true;
            }
            return false;
        };
         ...
         */
        OdpManager.prototype.close = function () {
            var _a;
            if (!this.enabled) {
                return;
            }
            (_a = this.eventManager) === null || _a === void 0 ? void 0 : _a.stop();
        };
        /**
        ...
        OdpManager.prototype.fetchQualifiedSegments = function (userId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (!this.enabled) {
                        this.logger.log(exports.LogLevel.ERROR, ERROR_MESSAGES.ODP_NOT_ENABLED);
                        return [2 /*return*/, null];
                    }
                    if (!this.segmentManager) {
                        this.logger.log(exports.LogLevel.ERROR, ERROR_MESSAGES.ODP_FETCH_QUALIFIED_SEGMENTS_SEGMENTS_MANAGER_MISSING);
                        return [2 /*return*/, null];
                    }
        ...
        OdpManager.prototype.identifyUser = function (userId, vuid) {
            if (!this.enabled) {
                this.logger.log(exports.LogLevel.DEBUG, LOG_MESSAGES.ODP_IDENTIFY_FAILED_ODP_DISABLED);
                return;
            }
            if (!this.odpConfig.isReady()) {
                this.logger.log(exports.LogLevel.DEBUG, LOG_MESSAGES.ODP_IDENTIFY_FAILED_ODP_NOT_INTEGRATED);
                return;
            }
            if (!this.eventManager) {
                this.logger.log(exports.LogLevel.ERROR, ERROR_MESSAGES.ODP_IDENTIFY_FAILED_EVENT_MANAGER_MISSING);
                return;
            }
    ...
    var ODP_CONFIG_NOT_READY_MESSAGE = 'ODP config not ready';
    /**
    ...
    var OdpEventApiManager = /** @class */ (function () {
         ...
         * @param odpConfig
         */
        OdpEventApiManager.prototype.updateSettings = function (odpConfig) {
         ...
         */
        OdpEventApiManager.prototype.sendEvents = function (events) {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function () {
                var shouldRetry, _c, method, endpoint, headers, data, statusCode, request, response, err_1, message;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            shouldRetry = false;
                            if (!((_a = this.odpConfig) === null || _a === void 0 ? void 0 : _a.isReady())) {
                                this.logger.log(exports.LogLevel.ERROR, "".concat(EVENT_SENDING_FAILURE_MESSAGE, " (").concat(ODP_CONFIG_NOT_READY_MESSAGE, ")"));
                            ...
                            _c = this.generateRequestData(events), method = _c.method, endpoint = _c.endpoint, headers = _c.headers, data = _c.data;
                            statusCode = 0;
                            _d.label = 1;
                        case 1:
                            _d.trys.push([1, 3, , 4]);
                        ...
                        case 2:
                            response = _d.sent();
                            statusCode = (_b = response.statusCode) !== null && _b !== void 0 ? _b : statusCode;
                            return [3 /*break*/, 4];
                        case 3:
                            err_1 = _d.sent();
    ...
    var BrowserOdpEventApiManager = /** @class */ (function (_super) {
        ...
        BrowserOdpEventApiManager.prototype.getPixelApiEndpoint = function () {
            var _a;
            if (!((_a = this.odpConfig) === null || _a === void 0 ? void 0 : _a.isReady())) {
                throw new Error(ODP_CONFIG_NOT_READY_MESSAGE);
            }
            var pixelUrl = this.odpConfig.pixelUrl;
            var pixelApiEndpoint = new URL(pixelApiPath, pixelUrl).href;
            return pixelApiEndpoint;
        };
        BrowserOdpEventApiManager.prototype.generateRequestData = function (events) {
            var _a;
            // the caller should ensure odpConfig is ready before calling
            if (!((_a = this.odpConfig) === null || _a === void 0 ? void 0 : _a.isReady())) {
                this.getLogger().log(exports.LogLevel.ERROR, ODP_CONFIG_NOT_READY_MESSAGE);
                throw new Error(ODP_CONFIG_NOT_READY_MESSAGE);
            }
            ...
            // refacator later
            var pixelApiEndpoint = this.getPixelApiEndpoint();
            var apiKey = this.odpConfig.apiKey;
            var method = 'GET';
            var event = events[0];
    ...
    var OdpEventManager = /** @class */ (function () {
        function OdpEventManager(_a) {
            var odpConfig = _a.odpConfig, apiManager = _a.apiManager, logger = _a.logger, clientEngine = _a.clientEngine, clientVersion = _a.clientVersion, queueSize = _a.queueSize, batchSize = _a.batchSize, flushInterval = _a.flushInterval, userAgentParser = _a.userAgentParser;
            /**
         ...
         */
        OdpEventManager.prototype.updateSettings = function (newConfig) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.processQueue(true)];
                        case 1:
                            _a.sent();
                            this.state = STATE.STOPPED;
        ...
        OdpEventManager.prototype.makeAndSend1Batch = function () {
            ...
            for (var count = 0; count < this.batchSize; count += 1) {
                var event_1 = this.queue.shift();
                if (event_1) {
                    batch.push(event_1);
                }
                else {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                attemptNumber = 0;
                                _a.label = 1;
                            case 1: return [4 /*yield*/, this.apiManager.sendEvents(batch)];
                            case 2:
                                shouldRetry = _a.sent();
                                attemptNumber += 1;
                                _a.label = 3;
                            case 3:
                                if (shouldRetry && attemptNumber < MAX_RETRIES) return [3 /*break*/, 1];
                                _a.label = 4;
         ...
         * @private
         */
        OdpEventManager.prototype.isOdpConfigurationReady = function () {
            if (this.odpConfig.isReady()) {
                return true;
            }
    ...
    var OdpSegmentManager = /** @class */ (function () {
        function OdpSegmentManager(odpConfig, segmentsCache, odpSegmentApiManager, logger) {
            this.odpConfig = odpConfig;
        ...
        OdpSegmentManager.prototype.fetchQualifiedSegments = function (userKey, userValue, options) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, odpApiHost, odpApiKey, segmentsToCheck, cacheKey, ignoreCache, resetCache, cachedSegments, segments;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this.odpConfig, odpApiHost = _a.apiHost, odpApiKey = _a.apiKey;
                            if (!odpApiKey || !odpApiHost) {
                                this.logger.log(exports.LogLevel.WARNING, ERROR_MESSAGES.FETCH_SEGMENTS_FAILED_INVALID_IDENTIFIER);
                                return [2 /*return*/, null];
                            }
                            ...
                            return [4 /*yield*/, this.odpSegmentApiManager.fetchSegments(odpApiKey, odpApiHost, userKey, userValue, segmentsToCheck)];
                        case 1:
                            segments = _b.sent();
    ...
    var BrowserOdpManager = /** @class */ (function (_super) {
        ...
        function BrowserOdpManager(_a) {
            var logger = _a.logger, odpOptions = _a.odpOptions;
            var _this = _super.call(this) || this;
            _this.logger = logger || getLogger();
            if (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.disabled) {
                _this.initPromise = Promise.resolve();
                _this.enabled = false;
                _this.logger.log(exports.LogLevel.INFO, LOG_MESSAGES.ODP_DISABLED);
                return _this;
            }
            var browserClientEngine = JAVASCRIPT_CLIENT_ENGINE;
            var browserClientVersion = BROWSER_CLIENT_VERSION;
            ...
            if (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.segmentsRequestHandler) {
                ...
                customSegmentRequestHandler = new BrowserRequestHandler(_this.logger, (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.segmentsApiTimeout) || REQUEST_TIMEOUT_ODP_SEGMENTS_MS);
            }
            ...
            if (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.segmentManager) {
                _this.segmentManager = odpOptions.segmentManager;
                _this.segmentManager.updateSettings(_this.odpConfig);
            }
            else {
                _this.segmentManager = new OdpSegmentManager(_this.odpConfig, (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.segmentsCache) ||
                    new BrowserLRUCache({
                    ...
                    }), new OdpSegmentApiManager(customSegmentRequestHandler, _this.logger));
            }
            ...
            if (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.eventRequestHandler) {
                ...
                customEventRequestHandler = new BrowserRequestHandler(_this.logger, (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.eventApiTimeout) || REQUEST_TIMEOUT_ODP_EVENTS_MS);
            }
            // Set up Events Manager (Events REST API Interface)
            if (odpOptions === null || odpOptions === void 0 ? void 0 : odpOptions.eventManager) {
                _this.eventManager = odpOptions.eventManager;
                _this.eventManager.updateSettings(_this.odpConfig);
            }
            else {
                _this.eventManager = new BrowserOdpEventManager({
                    odpConfig: _this.odpConfig,
                    apiManager: new BrowserOdpEventApiManager(customEventRequestHandler, _this.logger),
                    logger: _this.logger,
            ...
            _this.eventManager.start();
            _this.initPromise = _this.initializeVuid(BrowserOdpManager.cache).catch(function (e) {
                _this.logger.log(_this.enabled ? exports.LogLevel.ERROR : exports.LogLevel.DEBUG, e);
            });
            return _this;
        }
        /**
         ...
         * @private
         */
        BrowserOdpManager.prototype.initializeVuid = function (cache) {
            return __awaiter(this, void 0, void 0, function () {
                var vuidManager;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, VuidManager.instance(cache)];
                        case 1:
                            vuidManager = _a.sent();
        ...
        BrowserOdpManager.prototype.registerVuid = function (vuid) {
            if (!this.eventManager) {
                this.logger.log(exports.LogLevel.ERROR, ERROR_MESSAGES.ODP_VUID_REGISTRATION_FAILED_EVENT_MANAGER_MISSING);
                return;
            }
            try {
                ...
                this.logger.log(this.enabled ? exports.LogLevel.ERROR : exports.LogLevel.DEBUG, ERROR_MESSAGES.ODP_VUID_REGISTRATION_FAILED);
            }
        };
        /**
         * @override
    ...
    var Optimizely = /** @class */ (function () {
        function Optimizely(config) {
            ...
            this.disposeOnUpdate = this.projectConfigManager.onUpdate(function (configObj) {
                ...
                (_a = NotificationRegistry.getNotificationCenter(config.sdkKey)) === null || _a === void 0 ? void 0 : _a.sendNotifications(NOTIFICATION_TYPES.OPTIMIZELY_CONFIG_UPDATE);
            ...
            var dependentPromises = [projectConfigManagerReadyPromise, eventProcessorStartedPromise];
            if ((_b = config.odpManager) === null || _b === void 0 ? void 0 : _b.initPromise) {
                dependentPromises.push(config.odpManager.initPromise);
            }
            this.readyPromise = Promise.all(dependentPromises).then(function (promiseResults) {
                var _a, _b, _c;
                // If no odpManager exists yet, creates a new one
                if (config.odpManager != null) {
                    _this.odpManager = config.odpManager;
                    (_a = _this.odpManager.eventManager) === null || _a === void 0 ? void 0 : _a.start();
                    _this.updateOdpSettings();
                    var sdkKey = (_b = _this.projectConfigManager.getConfig()) === null || _b === void 0 ? void 0 : _b.sdkKey;
                    if (sdkKey != null) {
                        (_c = NotificationRegistry.getNotificationCenter(sdkKey, _this.logger)) === null || _c === void 0 ? void 0 : _c.addNotificationListener(NOTIFICATION_TYPES.OPTIMIZELY_CONFIG_UPDATE, function () { return _this.updateOdpSettings(); });
                    }
                    else {
                        _this.logger.log(LOG_LEVEL.ERROR, ERROR_MESSAGES.ODP_SDK_KEY_MISSING_NOTIFICATION_CENTER_FAILURE);
                    }
                }
        ...
        Optimizely.prototype.createUserContext = function (userId, attributes) {
            var _a;
            var userIdentifier;
            if (((_a = this.odpManager) === null || _a === void 0 ? void 0 : _a.isVuidEnabled()) && !userId) {
        ...
        Optimizely.prototype.updateOdpSettings = function () {
            ...
            if (this.odpManager != null && projectConfig != null) {
                this.odpManager.updateSettings(new OdpConfig(projectConfig.publicKeyForOdp, projectConfig.hostForOdp, projectConfig.pixelUrlForOdp, projectConfig.allSegments));
            }
        };
        /**
    ...
    var createInstance = function (config) {
        ...
        try {
            ...
            var optimizelyOptions = __assign(__assign({ clientEngine: JAVASCRIPT_CLIENT_ENGINE }, config), { eventProcessor: eventProcessor.createEventProcessor(eventProcessorConfig), logger: logger$d, errorHandler: errorHandler, datafileManager: config.sdkKey
                    ...
                    : undefined, notificationCenter: notificationCenter, isValidInstance: isValidInstance, odpManager: odpExplicitlyOff ? undefined : new BrowserOdpManager({ logger: logger$d, odpOptions: config.odpOptions }) });
